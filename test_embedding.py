...
if __name__ == "__main__":
    ...
    #batch_result = client.get_embedding_from_json("故宫旧称紫禁城")
    #print(f"JSON多文本向量结果：{batch_result}")

    # 示例3：若JSON中存储文本的字段不是"text"（比如"content"）
    # 文件内容：[{"content": "西湖是杭州的标志性景点"}]
    # batch_result = client.get_embedding_from_json("./texts_custom_field.json", text_field="content")